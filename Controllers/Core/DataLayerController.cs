...
namespace salon_essentials.Controllers.Core
{
    public class DataLayerController
    {
        private const string connectionString = "data source=DESKTOP-617JC56\\SQLEXPRESS; initial catalog=MyDB;Integrated Security=True";
